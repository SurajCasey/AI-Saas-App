...
const WriteArticle = () => {
  ...
  const articleLength = [
    ...
    {length: 1200, text: 'Medium (500-1200 words)'},
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='mt-6  text-sm font-medium'>Artile Topic</p>
        ...
        placeholder='The future of artificail intelligence is .. ' required/>
